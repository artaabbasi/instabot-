...
xpath["get_buttons_from_dialog"] = {
    ...
    "unfollow_button": "//div[text() = 'Following']",
}
...
xpath["get_following_status"] = {
    "follow_button_XP": "//div[text()='Following' or \
                                  text()='Requested' or \
                                  text()='Follow' or \
                                  text()='Follow Back' or \
                                  text()='Unblock' and not(ancestor::*/@role = 'presentation')]",
    "follow_span_XP_following": '//div[@class="_7UhW9   xLCgt        qyrsm            uL8Hv        T0kll "]',
}
...
xpath["like_comment"] = {
    "comments_block": "//div[@class='P9YgZ']",
    "span_like_elements": "//span[@class='jdtwu']",
    "comment_like_button": '//div[@class="_2ic5v"]/button[@class="wpO6b ZQScA "]/div[@class="QBdPU rrUvL"]',
}
...
xpath["open_comment_section"] = {
    "comment_elem": '//span[@class="_15y0l"]/button[@class="wpO6b  "]/div[@class="QBdPU rrUvL"]'
}
